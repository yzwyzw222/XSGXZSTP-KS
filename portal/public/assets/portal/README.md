...
| `images/extraction-nlp.webp` | 实体抽取插图 | 四张蓝紫半透明玻璃文档，轻微等距倾斜，电光蓝边缘，最前方仅写 NLP，左右留白 |
| `images/crawler-analytics.webp` | 爬虫平台插图 | 青色机器人位于透明平台左下，右上两块全息屏显示折线和柱图，等距 3D，无标题或文字 |
