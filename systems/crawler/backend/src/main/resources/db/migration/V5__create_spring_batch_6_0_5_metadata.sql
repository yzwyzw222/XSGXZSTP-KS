-- 表结构来自 spring-batch-core 6.0.5 的官方 schema-mysql.sql，由Flyway统一管理。
...
ALTER TABLE crawl_run
    ADD CONSTRAINT fk_crawl_run_batch_execution
    FOREIGN KEY (batch_job_execution_id) REFERENCES BATCH_JOB_EXECUTION (JOB_EXECUTION_ID);
