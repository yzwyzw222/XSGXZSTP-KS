...
const map: Record<string, { label: string; cls: string; dot: string }> = {
  ...
  PARTIAL_SUCCESS: { label: '部分成功', cls: 'text-warning bg-warning/12 border-warning/35', dot: 'bg-status-warning' },
  PAUSING: { label: '正在暂停', cls: 'text-warning bg-warning/12 border-warning/35', dot: 'bg-status-warning' },
  CANCELLING: { label: '正在取消', cls: 'text-warning bg-warning/12 border-warning/35', dot: 'bg-status-warning' },
  CANCELLED: { label: '已取消', cls: 'text-muted-foreground bg-muted border-border', dot: 'bg-status-idle' },
